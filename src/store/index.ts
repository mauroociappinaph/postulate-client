...
// Postulations Store
export { usePostulationsStore } from '../features/postulation/store/postulationsStore';
...
import * as PostulationsStore from '../features/postulation/store/postulationsStore';
...
export type { Postulation, PostulationState } from '../features/postulation/types/postulation';
