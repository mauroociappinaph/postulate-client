...
describe('String Helpers', () => {
  describe('getInitials', () => {
    ...
    test('debería devolver una cadena vacía para entrada null', () => {
      expect(getInitials(null as unknown as string)).toBe('');
    });

    test('debería devolver una cadena vacía para entrada undefined', () => {
      expect(getInitials(undefined as unknown as string)).toBe('');
    });
  });

  test('debería devolver una cadena vacía para entrada no string', () => {
...
describe('truncateText', () => {
  ...
  test('debería manejar una entrada undefined', () => {
    expect(truncateText(undefined as never, 20)).toBe('');
  });

  test('debería usar maxLength por defecto si no se proporciona', () => {
    const longText =
...
describe('normalizeSpaces', () => {
  ...
  test('should handle null input', () => {
    expect(normalizeSpaces(undefined as unknown as string)).toBe('');
  });
...
// Fin de las pruebas para normalizeSpaces
